...
class Navbar extends StatefulWidget implements PreferredSizeWidget {
  ...
  Navbar(
      ...
      this.noShadow = false,
      this.bgColor = NowUIColors.primary,
      this.searchBar = false});

  final double _prefferedHeight = 68.0;

  double height(){
    double toRet = _prefferedHeight;
    if(this.searchBar){
      toRet += 70;
    }
              ...
              children: [
                Row(
                  ...
                  children: [
                        ...
                        IconButton(
                            ...
                            onPressed: () {
                              if (!widget.backButton)
                                ...
                                //TODO fijarse como funciona el pop
                    ...
                    if (widget.rightOptions) //icono flag
                      Row(
