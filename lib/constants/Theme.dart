...
class NowUIColors {
  ...
  static const Color primary = Color.fromRGBO(254, 36, 114, 1.0);

  static const Color secondary = Color.fromRGBO(68, 68, 68, 1.0);

  static const Color label = Color.fromRGBO(249, 99, 50, 1.0);
  ...
  static const Color text = Color.fromRGBO(231, 231, 231, 1.0);

  static const Color bgColorScreen = Color.fromRGBO(36, 36, 36, 1.0);

  static const Color bgColorScreenTransparent = Color.fromRGBO(36, 36, 36, 0.7);
